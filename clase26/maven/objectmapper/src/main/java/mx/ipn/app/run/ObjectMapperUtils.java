...
import mx.ipn.app.model.Country;
import mx.ipn.app.model.Info;
...
public class ObjectMapperUtils {
	...
	public static void objectToJsonInFile() throws IOException {
		objectMapper.writeValue(new File("country.json"), country);
	}
	...
	public static void jsonInFileToObject() throws IOException {
		Country countryFromFile = objectMapper.readValue(new File("country.json"), Country.class);
